...
public class Order {
    ...
    protected Order(String address, int price, float cashback, float weight, List<Device> cart){
    ...
    protected Order(String address, int price, float cashback, float weight, Device device){
        this.address = address;
        devices.add(device);
        this.price = price;
        this.deliveryPrice += weight*100;
